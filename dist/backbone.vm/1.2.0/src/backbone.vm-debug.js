define("backbone.vm/1.2.0/src/backbone.vm-debug", ["jquery/1.10.2/jquery-debug", "underscore/1.6.0/underscore-debug", "backbone/1.1.2/backbone-debug"], function(require, exports, module) {
  ...
  var VMhooks = {
    ...
    checkboxOnClick: function(vm, name) {
      return function() {
        ...
        if (!this.checked) {
          checkboxList = _.filter(checkboxList, function(num) {
            return num !== value;
          });
        } else {
  ...
  _.extend(VM.prototype, {
    ...
    on: function(event, callback, context) {
      ...
      this._vm.on(event, callback, context);
    },
    off: function(event, callback, context) {
      if (!context) context = this;
      this._vm.off(event, callback, context);
    },
    once: function(event, callback, context) {
      if (!context) context = this;
      this._vm.once(event, callback, context);
    },
    previous: function(attr) {
      return this._vm.previous(attr);
    },
